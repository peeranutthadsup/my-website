      ...
      .then(data => {
        this.setState({
          form: {
            ...
            // แปลงค่า is_shopee, is_lazada เป็น string เพื่อใช้กับ select
  ...
  handleChange = (e) => {
    ...
    this.setState(state => {
      ...
      return {
        form: {
          ...state.form,
          [name]: String(value), // แปลงเป็น string เสมอ
        },
        validationErrors,
      };
    });
...
// สำหรับ Next.js ใช้ withRouter (หรือ useRouter ใน function component)
