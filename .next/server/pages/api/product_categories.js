...
async function handler(req, res) {
    ...
    try {
        const [rows] = await connection.execute("SELECT product_category_id, product_category_name, is_active FROM product_category WHERE is_active = 1");
...
var __webpack_exports__ = (__webpack_exec__(2337));
